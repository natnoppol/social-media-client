...
describe('register', () => {
    ...
    test('registers a user successfully', async () => {
        ...
        const result = await register('John Doe', 'johndoe@example.com', 'password123', 'https://example.com/avatar.jpg');
        ...
        test('throws an error when registration fails', async () => {
            ...
            await expect(register('John Doe', 'johndoe@example.com', 'password123', 'https://example.com/avatar.jpg')).rejects.toThrow('Internal Server Error');
          });
        });